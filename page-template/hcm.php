...
while (have_posts()):
    ...
    <div id="container">
        ...
        <div class="wrap">
            ...
            <h3 id="char" class="" style="display:none; "><?php the_field('mona_city_title_2') ?><span class="t_sc01_02"></span></h3>

            <!--fair_info-->
            <div class="fair_info st02 ty_t" style="display:none; ">
